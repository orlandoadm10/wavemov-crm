  ...
  return (
    <div>
      ...
      <div className="flex gap-2">
        <code className="flex h-10 min-w-0 flex-1 items-center overflow-x-auto rounded-lg border border-line bg-slate-50 px-3.5 text-xs whitespace-nowrap text-ink">
          {value}
        </code>
