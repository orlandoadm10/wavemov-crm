...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex min-h-screen">
      ...
      <div className="relative hidden w-[45%] flex-col justify-between overflow-hidden bg-gradient-brand p-10 lg:flex">
        <div
          aria-hidden
          className="absolute inset-0 opacity-60"
          style={{
            background:
              "radial-gradient(600px circle at 20% 15%, oklch(1 0 0 / 0.16), transparent 60%), radial-gradient(800px circle at 85% 90%, oklch(0.28 0.12 262 / 0.45), transparent 60%)",
          }}
        />
        <div className="relative flex items-center gap-3">
          ...
          <span className="font-display text-lg font-bold text-white">CRM JID Mídia</span>
        </div>
