  ...
  return (
    <div className="animate-fade-up rounded-2xl border border-line bg-card p-8 shadow-panel">
      ...
      {invalidLink && !state?.sent && (
        <p className="mt-4 rounded-lg bg-warning/10 px-3 py-2 text-sm text-warning-text">
          O link expirou ou já foi usado. Peça um novo abaixo — e abra-o no mesmo navegador.
        </p>
      )}

      {state?.sent ? (
        <div className="mt-6 space-y-3 rounded-lg bg-success/10 px-4 py-3 text-sm text-success-text">
